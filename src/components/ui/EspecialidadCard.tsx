...
export function EspecialidadCard({ icon_name, nombre, duracion, codigo, color_bg, color_border }: EspecialidadCardProps) {
  return (
    <Link href={`/especialidad/${codigo.toLowerCase()}`}>
      <article 
