    ...
    <main className="flex gap-5 p-10">
      ...
      <section className="grid grid-cols-3 gap-5 w-full bg-card rounded-lg p-5">
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 p-3">
          ...
          <label htmlFor="consigna" className="flex flex-col gap-1">
            Ejercicio:
            <textarea name="consigna" id="consigna" value={form.consigna} onChange={handleChange} required className="bg-gray-900"/>
          </label>
          <label htmlFor="respuesta">
            Respuesta:
            <input type="text" name="respuesta" value={form.respuesta} id="respuesta" onChange={handleChange} className="bg-gray-900"  />
          </label>
          <label htmlFor="video">
            Link video:
            <input type="text" name="video" value={form.video} id="video" onChange={handleChange} placeholder="https://youtube.com/watch?v=..." className="bg-gray-900" />
          </label>
